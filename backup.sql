...
--
-- Host: localhost    Database: mpower
-- ------------------------------------------------------
...
CREATE TABLE `admin` (
  ...
  `aname` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `arole` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `allskills` (
  ...
  `skill` varchar(750) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `application` (
  ...
  `why_desc` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `course` (
  `id` int NOT NULL AUTO_INCREMENT,
  `course` varchar(512) COLLATE utf8mb4_general_ci NOT NULL,
  `description` varchar(512) COLLATE utf8mb4_general_ci NOT NULL,
  `institution_type` varchar(512) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `education` (
  ...
  `time_period` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `employer` (
  ...
  `ename` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `etype` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `executive` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `phone` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `location` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `profile` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `logo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `log_id_id` int DEFAULT NULL,
  `city` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fblink` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `inlink` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `lnlink` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `size` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `twlink` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `website` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `yearfounded` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cover` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `feedback` (
  ...
  `emp_feedback` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `interview` (
  ...
  `int_link` varchar(300) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `eid_id` int DEFAULT NULL,
  `user_id_id` int DEFAULT NULL,
  `schedule_date` datetime(6) NOT NULL,
  `is_done` tinyint(1) NOT NULL,
  `cand_feedback` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `jobs` (
  ...
  `title` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jobdesc` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vacno` int DEFAULT NULL,
  `experience` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `basicpay` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fnarea` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `location` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `industry` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ugqual` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pgqual` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `profile` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `postdate` datetime(6) NOT NULL,
  `eid_id` int DEFAULT NULL,
  `jobtype` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `skills` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `requirements` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `responsibilities` varchar(700) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `num_of_visits` int NOT NULL,
  `notice_period` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` int DEFAULT '3',
  `suggestions` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT '[]',
  PRIMARY KEY (`jobid`),
...
CREATE TABLE `jobseeker` (
  ...
  `location` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `experience` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `skills` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `basic_edu` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `master_edu` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `other_qual` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `expsal` int NOT NULL,
  `notice_period` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `role` varchar(750) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
CREATE TABLE `notifications` (
  ...
  `notif_type` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `profilevisits` (
  ...
  `user_id_id` int DEFAULT NULL,
  `user_type` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `resumeanalysis` (
  ...
  `resume_score` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `date` date NOT NULL,
  `no_of_pages` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `predicted_field` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_level` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `actual_skills` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reco_skills` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reco_courses` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `recommendations` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `roledetails` (
  `id` int NOT NULL AUTO_INCREMENT,
  `role` varchar(750) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `testinfo` (
  ...
  `test_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `eid_id` int DEFAULT NULL,
...
CREATE TABLE `testques` (
  ...
  `ques_name` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `option1` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `option2` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `testuser` (
  ...
  `answers` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `date` datetime(6) NOT NULL,
  `test_id_id` int DEFAULT NULL,
  `user_id_id` int DEFAULT NULL,
  `emp_id_id` int DEFAULT NULL,
...
-- Dump completed on 2023-08-29 13:34:04
