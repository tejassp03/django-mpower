...
urlpatterns = [
	...
	path('edit_profile/add_training/', views.add_training, name='add_training'),
	...
	path('edit_profile/delete_training/', views.delete_training, name='delete_training'),
	...
	path('edit_training/', views.edit_training, name='edit_training'),
	...
	path('attempt/<int:pk2>/<int:pk3>/', views.attempt, name='attempt'),
    ...
    path('feedback/<int:pk1>/', views.feedback, name='feedback'),
